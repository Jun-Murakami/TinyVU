...
if [[ ${BUILD_AAX} -eq 1 ]]; then
    cmake --build "${BUILD_DIR}" --config "${CONFIGURATION}" --target TinyVU_VST3 TinyVU_AU TinyVU_Standalone TinyVU_AAX
else
    cmake --build "${BUILD_DIR}" --config "${CONFIGURATION}" --target TinyVU_VST3 TinyVU_AU TinyVU_Standalone
fi
...
if [[ ${BUILD_AAX} -eq 1 ]]; then
    ZIP_NAME="TinyVU_${VERSION}_macOS_VST3_AU_AAX_Standalone.zip"
else
    ZIP_NAME="TinyVU_${VERSION}_macOS_VST3_AU_Standalone.zip"
fi
